...
source.exclude_patterns = setup.py,main_pc.py,Crazyy-Simulation.spec,setup.spec
version = 1.0.0
# Landscape 800x600 logical playfield; pygame.SCALED letterboxes 19.5:9 / 20:9 screens cleanly
orientation = landscape
fullscreen = 1
requirements = python3,pygame,android,pyjnius,requests,certifi,python-dotenv,urllib3,idna,charset-normalizer
presplash.filename = 
icon.filename = 
